#ifndef WSF_UTIL_HTTP_STATUS_CODE_HPP
#define WSF_UTIL_HTTP_STATUS_CODE_HPP
#include <string>
namespace wsf {
	namespace http {
		...
		static inline const char* const reason(status_code code) { return reason(static_cast<int>(code)); }
	}
}
#endif