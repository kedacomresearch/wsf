...
/**
 * list_add_tail - add a newer entry
 * @newer: newer entry to be added
 ...
 * @newer : the new element to insert
 *
 * If @old was empty, it will be overwritten.
 */
static inline void list_replace(struct list_head *old,
                                struct list_head *newer)
{
    newer->next = old->next;
...
/************************************************************************/
/*  list_head for C++ utils                                             */
/*   to use this util, you have to define self_ as C++ Item member      */
/* for example                                                          */
/* struct Item{                                                         */
/*    list_head self_;                                                  */
/*    ......		                                                    */
...
namespace kedacom
{
    namespace typesys
    {
        //to use this class ,you have define the header as self_ in the list
        template <typename _Item>
        class List
        {
        public:
            explicit List(struct list_head &head)
            {
                this->head_ = head;
            }
            ...
            {
            public:
                explicit iterator(struct list_head *item)
                    : item_(item)
                {
                }
                iterator &operator++()
                ...
                _Item &operator*()
                {
                    return *list_entry(item_, _Item, self_);
                }
